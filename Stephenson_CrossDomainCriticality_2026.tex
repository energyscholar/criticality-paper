...
We classify each surveyed domain as independent derivation, domain transfer, or empirical precursor, and present citation network evidence that cross-domain citations remained significantly below random-mixing expectations (under a simple null model of domain mixing) during the formative period (1987--2010). We separately present Metatron Dynamics, a framework derived from distributed systems engineering, as a candidate additional instance in Appendix~A, classified as unvalidated given the authors' dual role.
...
Metatron Dynamics & Candidate (unvalidated) & See Appendix~\ref{app:correspondence} \\
\bottomrule
\end{tabular}
\end{table}
